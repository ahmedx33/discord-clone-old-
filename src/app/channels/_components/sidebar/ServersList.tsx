...
export default async function ServersList() {
    ...
    return (
        <div className="flex flex-col gap-2 bg-[#1E1F22] w-fit h-screen p-2">
            <Link href="/channels" className="main-icon"><ServerS defaultBg className={`main-blue ${pathname === "/channels" ? "!rounded-[17px] !bg-blue" : ""}`} width={30} height={30} icon="/svgs/discord.svg" name="Direct Messages" /></Link>
