                            ...
                            <ActionTooltip key={server.id} label={server.name} side="right" align="center">
                                <li key={server.id}>
                                    <Link href={`/channels/${server.id}/`} onClick={() => dispatch(onCloseMemberList())}>
                                        <div className={cn("flex items-center relative justify-center w-[50px] h-[50px] group cursor-pointer rounded-full")}>
                                            <div
                                                className={cn(
                                                    "flex items-center justify-center w-full h-full rounded-full mk-Smooth overflow-hidden",
